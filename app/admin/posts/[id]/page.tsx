  ...
  return (
    <main style={{ padding: 24 }}>
      ...
      <div style={{ display: "flex", gap: 12, margin: "12px 0" }}>
        <Link href="/admin/posts">发言记录</Link>
      </div>
              ...
              <div style={{ display: "flex", gap: 8, alignItems: "center" }}>
                <span
                  style={{
                    ...
                    background: post.source === "feedback" ? "#111827" : "#111827",
                  }}
                >
                  {post.source}
                </span>
                ...
                {post.author?.user_id ? (
                  <span style={{ fontFamily: "monospace", fontSize: 12, color: "#94a3b8" }}>{post.author.user_id}</span>
                ) : null}
              </div>
